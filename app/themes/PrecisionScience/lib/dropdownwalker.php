...
class wp_sage_dropdownwalker extends Walker {
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $output .= "\t<option class=\"level-$depth\" value=\"" . esc_attr( $page->guid ) . '"';
        //$output .= "\t<span class=\"option\" data-value=\"" . esc_attr( $page->guid ) . '"';
/*
